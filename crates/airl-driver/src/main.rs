...
fn all_builtins() -> Vec<BuiltinMeta> {
    vec![
        ...
        BuiltinMeta { name: "bc-func-is-main?", sig: "(bcf : BCFunc) -> Bool", doc: "True when the function's name is `__main__`. Operates on BCFuncNative values emitted by `bc-func-from`.", category: "system" },
